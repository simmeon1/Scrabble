...
namespace Scrabble.Models
{
    public class ScrabbleContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<GameLanguage>().HasData(new GameLanguage { ID = 2, Language = "Bulgarian", CountOfLetters = 30 });


            modelBuilder.Entity<WordDictionary>().HasData(new WordDictionary { ID = 1, GameLanguageID = 1 });
            modelBuilder.Entity<WordDictionary>().HasData(new WordDictionary { ID = 2, GameLanguageID = 2 });
            ...
            modelBuilder.Entity<Game>().HasData(new Game { ID = 2, GameLanguageID = 2, BoardID = 2, PouchID = 2, WordDictionaryID = 2, Log = "Enjoy the game!" });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 226, BoardLocationX = 0, BoardLocationY = 0, BoardID = 2, BoardTileTypeID = 5 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 227, BoardLocationX = 1, BoardLocationY = 0, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 228, BoardLocationX = 2, BoardLocationY = 0, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 229, BoardLocationX = 3, BoardLocationY = 0, BoardID = 2, BoardTileTypeID = 2 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 230, BoardLocationX = 4, BoardLocationY = 0, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 231, BoardLocationX = 5, BoardLocationY = 0, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 232, BoardLocationX = 6, BoardLocationY = 0, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 233, BoardLocationX = 7, BoardLocationY = 0, BoardID = 2, BoardTileTypeID = 5 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 234, BoardLocationX = 8, BoardLocationY = 0, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 235, BoardLocationX = 9, BoardLocationY = 0, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 236, BoardLocationX = 10, BoardLocationY = 0, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 237, BoardLocationX = 11, BoardLocationY = 0, BoardID = 2, BoardTileTypeID = 2 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 238, BoardLocationX = 12, BoardLocationY = 0, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 239, BoardLocationX = 13, BoardLocationY = 0, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 240, BoardLocationX = 14, BoardLocationY = 0, BoardID = 2, BoardTileTypeID = 5 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 241, BoardLocationX = 0, BoardLocationY = 1, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 242, BoardLocationX = 1, BoardLocationY = 1, BoardID = 2, BoardTileTypeID = 4 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 243, BoardLocationX = 2, BoardLocationY = 1, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 244, BoardLocationX = 3, BoardLocationY = 1, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 245, BoardLocationX = 4, BoardLocationY = 1, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 246, BoardLocationX = 5, BoardLocationY = 1, BoardID = 2, BoardTileTypeID = 3 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 247, BoardLocationX = 6, BoardLocationY = 1, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 248, BoardLocationX = 7, BoardLocationY = 1, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 249, BoardLocationX = 8, BoardLocationY = 1, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 250, BoardLocationX = 9, BoardLocationY = 1, BoardID = 2, BoardTileTypeID = 3 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 251, BoardLocationX = 10, BoardLocationY = 1, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 252, BoardLocationX = 11, BoardLocationY = 1, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 253, BoardLocationX = 12, BoardLocationY = 1, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 254, BoardLocationX = 13, BoardLocationY = 1, BoardID = 2, BoardTileTypeID = 4 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 255, BoardLocationX = 14, BoardLocationY = 1, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 256, BoardLocationX = 0, BoardLocationY = 2, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 257, BoardLocationX = 1, BoardLocationY = 2, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 258, BoardLocationX = 2, BoardLocationY = 2, BoardID = 2, BoardTileTypeID = 4 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 259, BoardLocationX = 3, BoardLocationY = 2, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 260, BoardLocationX = 4, BoardLocationY = 2, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 261, BoardLocationX = 5, BoardLocationY = 2, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 262, BoardLocationX = 6, BoardLocationY = 2, BoardID = 2, BoardTileTypeID = 2 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 263, BoardLocationX = 7, BoardLocationY = 2, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 264, BoardLocationX = 8, BoardLocationY = 2, BoardID = 2, BoardTileTypeID = 2 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 265, BoardLocationX = 9, BoardLocationY = 2, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 266, BoardLocationX = 10, BoardLocationY = 2, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 267, BoardLocationX = 11, BoardLocationY = 2, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 268, BoardLocationX = 12, BoardLocationY = 2, BoardID = 2, BoardTileTypeID = 4 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 269, BoardLocationX = 13, BoardLocationY = 2, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 270, BoardLocationX = 14, BoardLocationY = 2, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 271, BoardLocationX = 0, BoardLocationY = 3, BoardID = 2, BoardTileTypeID = 2 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 272, BoardLocationX = 1, BoardLocationY = 3, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 273, BoardLocationX = 2, BoardLocationY = 3, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 274, BoardLocationX = 3, BoardLocationY = 3, BoardID = 2, BoardTileTypeID = 4 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 275, BoardLocationX = 4, BoardLocationY = 3, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 276, BoardLocationX = 5, BoardLocationY = 3, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 277, BoardLocationX = 6, BoardLocationY = 3, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 278, BoardLocationX = 7, BoardLocationY = 3, BoardID = 2, BoardTileTypeID = 2 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 279, BoardLocationX = 8, BoardLocationY = 3, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 280, BoardLocationX = 9, BoardLocationY = 3, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 281, BoardLocationX = 10, BoardLocationY = 3, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 282, BoardLocationX = 11, BoardLocationY = 3, BoardID = 2, BoardTileTypeID = 4 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 283, BoardLocationX = 12, BoardLocationY = 3, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 284, BoardLocationX = 13, BoardLocationY = 3, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 285, BoardLocationX = 14, BoardLocationY = 3, BoardID = 2, BoardTileTypeID = 2 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 286, BoardLocationX = 0, BoardLocationY = 4, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 287, BoardLocationX = 1, BoardLocationY = 4, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 288, BoardLocationX = 2, BoardLocationY = 4, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 289, BoardLocationX = 3, BoardLocationY = 4, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 290, BoardLocationX = 4, BoardLocationY = 4, BoardID = 2, BoardTileTypeID = 4 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 291, BoardLocationX = 5, BoardLocationY = 4, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 292, BoardLocationX = 6, BoardLocationY = 4, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 293, BoardLocationX = 7, BoardLocationY = 4, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 294, BoardLocationX = 8, BoardLocationY = 4, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 295, BoardLocationX = 9, BoardLocationY = 4, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 296, BoardLocationX = 10, BoardLocationY = 4, BoardID = 2, BoardTileTypeID = 4 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 297, BoardLocationX = 11, BoardLocationY = 4, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 298, BoardLocationX = 12, BoardLocationY = 4, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 299, BoardLocationX = 13, BoardLocationY = 4, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 300, BoardLocationX = 14, BoardLocationY = 4, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 301, BoardLocationX = 0, BoardLocationY = 5, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 302, BoardLocationX = 1, BoardLocationY = 5, BoardID = 2, BoardTileTypeID = 3 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 303, BoardLocationX = 2, BoardLocationY = 5, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 304, BoardLocationX = 3, BoardLocationY = 5, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 305, BoardLocationX = 4, BoardLocationY = 5, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 306, BoardLocationX = 5, BoardLocationY = 5, BoardID = 2, BoardTileTypeID = 3 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 307, BoardLocationX = 6, BoardLocationY = 5, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 308, BoardLocationX = 7, BoardLocationY = 5, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 309, BoardLocationX = 8, BoardLocationY = 5, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 310, BoardLocationX = 9, BoardLocationY = 5, BoardID = 2, BoardTileTypeID = 3 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 311, BoardLocationX = 10, BoardLocationY = 5, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 312, BoardLocationX = 11, BoardLocationY = 5, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 313, BoardLocationX = 12, BoardLocationY = 5, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 314, BoardLocationX = 13, BoardLocationY = 5, BoardID = 2, BoardTileTypeID = 3 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 315, BoardLocationX = 14, BoardLocationY = 5, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 316, BoardLocationX = 0, BoardLocationY = 6, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 317, BoardLocationX = 1, BoardLocationY = 6, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 318, BoardLocationX = 2, BoardLocationY = 6, BoardID = 2, BoardTileTypeID = 2 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 319, BoardLocationX = 3, BoardLocationY = 6, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 320, BoardLocationX = 4, BoardLocationY = 6, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 321, BoardLocationX = 5, BoardLocationY = 6, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 322, BoardLocationX = 6, BoardLocationY = 6, BoardID = 2, BoardTileTypeID = 2 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 323, BoardLocationX = 7, BoardLocationY = 6, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 324, BoardLocationX = 8, BoardLocationY = 6, BoardID = 2, BoardTileTypeID = 2 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 325, BoardLocationX = 9, BoardLocationY = 6, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 326, BoardLocationX = 10, BoardLocationY = 6, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 327, BoardLocationX = 11, BoardLocationY = 6, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 328, BoardLocationX = 12, BoardLocationY = 6, BoardID = 2, BoardTileTypeID = 2 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 329, BoardLocationX = 13, BoardLocationY = 6, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 330, BoardLocationX = 14, BoardLocationY = 6, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 331, BoardLocationX = 0, BoardLocationY = 7, BoardID = 2, BoardTileTypeID = 5 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 332, BoardLocationX = 1, BoardLocationY = 7, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 333, BoardLocationX = 2, BoardLocationY = 7, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 334, BoardLocationX = 3, BoardLocationY = 7, BoardID = 2, BoardTileTypeID = 2 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 335, BoardLocationX = 4, BoardLocationY = 7, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 336, BoardLocationX = 5, BoardLocationY = 7, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 337, BoardLocationX = 6, BoardLocationY = 7, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 338, BoardLocationX = 7, BoardLocationY = 7, BoardID = 2, BoardTileTypeID = 6 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 339, BoardLocationX = 8, BoardLocationY = 7, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 340, BoardLocationX = 9, BoardLocationY = 7, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 341, BoardLocationX = 10, BoardLocationY = 7, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 342, BoardLocationX = 11, BoardLocationY = 7, BoardID = 2, BoardTileTypeID = 2 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 343, BoardLocationX = 12, BoardLocationY = 7, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 344, BoardLocationX = 13, BoardLocationY = 7, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 345, BoardLocationX = 14, BoardLocationY = 7, BoardID = 2, BoardTileTypeID = 5 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 346, BoardLocationX = 0, BoardLocationY = 8, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 347, BoardLocationX = 1, BoardLocationY = 8, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 348, BoardLocationX = 2, BoardLocationY = 8, BoardID = 2, BoardTileTypeID = 2 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 349, BoardLocationX = 3, BoardLocationY = 8, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 350, BoardLocationX = 4, BoardLocationY = 8, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 351, BoardLocationX = 5, BoardLocationY = 8, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 352, BoardLocationX = 6, BoardLocationY = 8, BoardID = 2, BoardTileTypeID = 2 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 353, BoardLocationX = 7, BoardLocationY = 8, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 354, BoardLocationX = 8, BoardLocationY = 8, BoardID = 2, BoardTileTypeID = 2 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 355, BoardLocationX = 9, BoardLocationY = 8, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 356, BoardLocationX = 10, BoardLocationY = 8, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 357, BoardLocationX = 11, BoardLocationY = 8, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 358, BoardLocationX = 12, BoardLocationY = 8, BoardID = 2, BoardTileTypeID = 2 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 359, BoardLocationX = 13, BoardLocationY = 8, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 360, BoardLocationX = 14, BoardLocationY = 8, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 361, BoardLocationX = 0, BoardLocationY = 9, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 362, BoardLocationX = 1, BoardLocationY = 9, BoardID = 2, BoardTileTypeID = 3 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 363, BoardLocationX = 2, BoardLocationY = 9, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 364, BoardLocationX = 3, BoardLocationY = 9, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 365, BoardLocationX = 4, BoardLocationY = 9, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 366, BoardLocationX = 5, BoardLocationY = 9, BoardID = 2, BoardTileTypeID = 3 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 367, BoardLocationX = 6, BoardLocationY = 9, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 368, BoardLocationX = 7, BoardLocationY = 9, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 369, BoardLocationX = 8, BoardLocationY = 9, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 370, BoardLocationX = 9, BoardLocationY = 9, BoardID = 2, BoardTileTypeID = 3 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 371, BoardLocationX = 10, BoardLocationY = 9, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 372, BoardLocationX = 11, BoardLocationY = 9, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 373, BoardLocationX = 12, BoardLocationY = 9, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 374, BoardLocationX = 13, BoardLocationY = 9, BoardID = 2, BoardTileTypeID = 3 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 375, BoardLocationX = 14, BoardLocationY = 9, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 376, BoardLocationX = 0, BoardLocationY = 10, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 377, BoardLocationX = 1, BoardLocationY = 10, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 378, BoardLocationX = 2, BoardLocationY = 10, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 379, BoardLocationX = 3, BoardLocationY = 10, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 380, BoardLocationX = 4, BoardLocationY = 10, BoardID = 2, BoardTileTypeID = 4 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 381, BoardLocationX = 5, BoardLocationY = 10, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 382, BoardLocationX = 6, BoardLocationY = 10, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 383, BoardLocationX = 7, BoardLocationY = 10, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 384, BoardLocationX = 8, BoardLocationY = 10, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 385, BoardLocationX = 9, BoardLocationY = 10, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 386, BoardLocationX = 10, BoardLocationY = 10, BoardID = 2, BoardTileTypeID = 4 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 387, BoardLocationX = 11, BoardLocationY = 10, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 388, BoardLocationX = 12, BoardLocationY = 10, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 389, BoardLocationX = 13, BoardLocationY = 10, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 390, BoardLocationX = 14, BoardLocationY = 10, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 391, BoardLocationX = 0, BoardLocationY = 11, BoardID = 2, BoardTileTypeID = 2 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 392, BoardLocationX = 1, BoardLocationY = 11, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 393, BoardLocationX = 2, BoardLocationY = 11, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 394, BoardLocationX = 3, BoardLocationY = 11, BoardID = 2, BoardTileTypeID = 4 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 395, BoardLocationX = 4, BoardLocationY = 11, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 396, BoardLocationX = 5, BoardLocationY = 11, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 397, BoardLocationX = 6, BoardLocationY = 11, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 398, BoardLocationX = 7, BoardLocationY = 11, BoardID = 2, BoardTileTypeID = 2 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 399, BoardLocationX = 8, BoardLocationY = 11, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 400, BoardLocationX = 9, BoardLocationY = 11, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 401, BoardLocationX = 10, BoardLocationY = 11, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 402, BoardLocationX = 11, BoardLocationY = 11, BoardID = 2, BoardTileTypeID = 4 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 403, BoardLocationX = 12, BoardLocationY = 11, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 404, BoardLocationX = 13, BoardLocationY = 11, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 405, BoardLocationX = 14, BoardLocationY = 11, BoardID = 2, BoardTileTypeID = 2 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 406, BoardLocationX = 0, BoardLocationY = 12, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 407, BoardLocationX = 1, BoardLocationY = 12, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 408, BoardLocationX = 2, BoardLocationY = 12, BoardID = 2, BoardTileTypeID = 4 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 409, BoardLocationX = 3, BoardLocationY = 12, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 410, BoardLocationX = 4, BoardLocationY = 12, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 411, BoardLocationX = 5, BoardLocationY = 12, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 412, BoardLocationX = 6, BoardLocationY = 12, BoardID = 2, BoardTileTypeID = 2 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 413, BoardLocationX = 7, BoardLocationY = 12, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 414, BoardLocationX = 8, BoardLocationY = 12, BoardID = 2, BoardTileTypeID = 2 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 415, BoardLocationX = 9, BoardLocationY = 12, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 416, BoardLocationX = 10, BoardLocationY = 12, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 417, BoardLocationX = 11, BoardLocationY = 12, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 418, BoardLocationX = 12, BoardLocationY = 12, BoardID = 2, BoardTileTypeID = 4 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 419, BoardLocationX = 13, BoardLocationY = 12, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 420, BoardLocationX = 14, BoardLocationY = 12, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 421, BoardLocationX = 0, BoardLocationY = 13, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 422, BoardLocationX = 1, BoardLocationY = 13, BoardID = 2, BoardTileTypeID = 4 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 423, BoardLocationX = 2, BoardLocationY = 13, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 424, BoardLocationX = 3, BoardLocationY = 13, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 425, BoardLocationX = 4, BoardLocationY = 13, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 426, BoardLocationX = 5, BoardLocationY = 13, BoardID = 2, BoardTileTypeID = 3 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 427, BoardLocationX = 6, BoardLocationY = 13, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 428, BoardLocationX = 7, BoardLocationY = 13, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 429, BoardLocationX = 8, BoardLocationY = 13, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 430, BoardLocationX = 9, BoardLocationY = 13, BoardID = 2, BoardTileTypeID = 3 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 431, BoardLocationX = 10, BoardLocationY = 13, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 432, BoardLocationX = 11, BoardLocationY = 13, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 433, BoardLocationX = 12, BoardLocationY = 13, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 434, BoardLocationX = 13, BoardLocationY = 13, BoardID = 2, BoardTileTypeID = 4 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 435, BoardLocationX = 14, BoardLocationY = 13, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 436, BoardLocationX = 0, BoardLocationY = 14, BoardID = 2, BoardTileTypeID = 5 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 437, BoardLocationX = 1, BoardLocationY = 14, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 438, BoardLocationX = 2, BoardLocationY = 14, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 439, BoardLocationX = 3, BoardLocationY = 14, BoardID = 2, BoardTileTypeID = 2 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 440, BoardLocationX = 4, BoardLocationY = 14, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 441, BoardLocationX = 5, BoardLocationY = 14, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 442, BoardLocationX = 6, BoardLocationY = 14, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 443, BoardLocationX = 7, BoardLocationY = 14, BoardID = 2, BoardTileTypeID = 5 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 444, BoardLocationX = 8, BoardLocationY = 14, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 445, BoardLocationX = 9, BoardLocationY = 14, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 446, BoardLocationX = 10, BoardLocationY = 14, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 447, BoardLocationX = 11, BoardLocationY = 14, BoardID = 2, BoardTileTypeID = 2 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 448, BoardLocationX = 12, BoardLocationY = 14, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 449, BoardLocationX = 13, BoardLocationY = 14, BoardID = 2, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 450, BoardLocationX = 14, BoardLocationY = 14, BoardID = 2, BoardTileTypeID = 5 });
            ...
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 54, Letter = '*', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 55, Letter = 'А', Score = 1, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 56, Letter = 'Б', Score = 2, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 57, Letter = 'В', Score = 2, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 58, Letter = 'Г', Score = 3, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 59, Letter = 'Д', Score = 2, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 60, Letter = 'Е', Score = 1, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 61, Letter = 'Ж', Score = 4, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 62, Letter = 'З', Score = 4, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 63, Letter = 'И', Score = 1, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 64, Letter = 'Й', Score = 5, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 65, Letter = 'К', Score = 2, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 66, Letter = 'Л', Score = 2, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 67, Letter = 'М', Score = 2, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 68, Letter = 'Н', Score = 1, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 69, Letter = 'О', Score = 1, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 70, Letter = 'П', Score = 1, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 71, Letter = 'Р', Score = 1, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 72, Letter = 'С', Score = 1, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 73, Letter = 'Т', Score = 1, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 74, Letter = 'У', Score = 5, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 75, Letter = 'Ф', Score = 10, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 76, Letter = 'Х', Score = 5, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 77, Letter = 'Ц', Score = 8, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 78, Letter = 'Ч', Score = 5, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 79, Letter = 'Ш', Score = 8, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 80, Letter = 'Щ', Score = 10, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 81, Letter = 'Ъ', Score = 3, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 82, Letter = 'Ь', Score = 10, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 83, Letter = 'Ю', Score = 8, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 84, Letter = 'Я', Score = 5, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 85, Letter = 'А', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 86, Letter = 'Б', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 87, Letter = 'В', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 88, Letter = 'Г', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 89, Letter = 'Д', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 90, Letter = 'Е', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 91, Letter = 'Ж', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 92, Letter = 'З', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 93, Letter = 'И', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 94, Letter = 'Й', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 95, Letter = 'К', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 96, Letter = 'Л', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 97, Letter = 'М', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 98, Letter = 'Н', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 99, Letter = 'О', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 100, Letter = 'П', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 101, Letter = 'Р', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 102, Letter = 'С', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 103, Letter = 'Т', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 104, Letter = 'У', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 105, Letter = 'Ф', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 106, Letter = 'Х', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 107, Letter = 'Ц', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 108, Letter = 'Ч', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 109, Letter = 'Ш', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 110, Letter = 'Щ', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 111, Letter = 'Ъ', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 112, Letter = 'Ь', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 113, Letter = 'Ю', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 114, Letter = 'Я', Score = 0, GameLanguageID = 2, WordDictionaryID = 2 });
            ...
            modelBuilder.Entity<Player>().HasData(new Player { ID = 3, IsHuman = true, Score = 0, GameID = 2, RackID = 3, PouchID = 2, AtHand = true });
            modelBuilder.Entity<Player>().HasData(new Player { ID = 4, IsHuman = false, Score = 0, GameID = 2, RackID = 4, PouchID = 2, AtHand = false });
            ...
            modelBuilder.Entity<Rack>().HasData(new Rack { ID = 3, PouchID = 2, RackSize = 7, GameID = 2, PlayerID = 3 });
            modelBuilder.Entity<Rack>().HasData(new Rack { ID = 4, PouchID = 2, RackSize = 7, GameID = 2, PlayerID = 4 });
