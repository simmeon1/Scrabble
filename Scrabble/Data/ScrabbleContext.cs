...
namespace Scrabble.Models
{
    public class ScrabbleContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Game>().HasData(new Game { ID = 1, GameLanguageID = 1, BoardID = 1, PouchID = 1 });

            modelBuilder.Entity<Board>().HasData(new Board { ID = 1, Rows = 4, Columns = 4, GameID = 1 });
            modelBuilder.Entity<BoardTileType>().HasData(new BoardTileType { ID = 1, Type = "Normal" });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 1, BoardLocationX = 0, BoardLocationY = 0, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 4, BoardLocationX = 3, BoardLocationY = 0, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 8, BoardLocationX = 7, BoardLocationY = 0, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 12, BoardLocationX = 11, BoardLocationY = 0, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 15, BoardLocationX = 14, BoardLocationY = 0, BoardID = 1, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 16, BoardLocationX = 0, BoardLocationY = 1, BoardID = 1, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 17, BoardLocationX = 1, BoardLocationY = 1, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 21, BoardLocationX = 5, BoardLocationY = 1, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 25, BoardLocationX = 9, BoardLocationY = 1, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 29, BoardLocationX = 13, BoardLocationY = 1, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 33, BoardLocationX = 2, BoardLocationY = 2, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 37, BoardLocationX = 6, BoardLocationY = 2, BoardID = 1, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 38, BoardLocationX = 7, BoardLocationY = 2, BoardID = 1, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 39, BoardLocationX = 8, BoardLocationY = 2, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 43, BoardLocationX = 12, BoardLocationY = 2, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 46, BoardLocationX = 0, BoardLocationY = 3, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 49, BoardLocationX = 3, BoardLocationY = 3, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 53, BoardLocationX = 7, BoardLocationY = 3, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 57, BoardLocationX = 11, BoardLocationY = 3, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 60, BoardLocationX = 14, BoardLocationY = 3, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 65, BoardLocationX = 4, BoardLocationY = 4, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 71, BoardLocationX = 10, BoardLocationY = 4, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 77, BoardLocationX = 1, BoardLocationY = 5, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 81, BoardLocationX = 5, BoardLocationY = 5, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 85, BoardLocationX = 9, BoardLocationY = 5, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 89, BoardLocationX = 13, BoardLocationY = 5, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 93, BoardLocationX = 2, BoardLocationY = 6, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 97, BoardLocationX = 6, BoardLocationY = 6, BoardID = 1, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 98, BoardLocationX = 7, BoardLocationY = 6, BoardID = 1, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 99, BoardLocationX = 8, BoardLocationY = 6, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 103, BoardLocationX = 12, BoardLocationY = 6, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 106, BoardLocationX = 0, BoardLocationY = 7, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 109, BoardLocationX = 3, BoardLocationY = 7, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 113, BoardLocationX = 7, BoardLocationY = 7, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 117, BoardLocationX = 11, BoardLocationY = 7, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 120, BoardLocationX = 14, BoardLocationY = 7, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 123, BoardLocationX = 2, BoardLocationY = 8, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 127, BoardLocationX = 6, BoardLocationY = 8, BoardID = 1, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 128, BoardLocationX = 7, BoardLocationY = 8, BoardID = 1, BoardTileTypeID = 1 });
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 129, BoardLocationX = 8, BoardLocationY = 8, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 133, BoardLocationX = 12, BoardLocationY = 8, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 137, BoardLocationX = 1, BoardLocationY = 9, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 141, BoardLocationX = 5, BoardLocationY = 9, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 145, BoardLocationX = 9, BoardLocationY = 9, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 149, BoardLocationX = 13, BoardLocationY = 9, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 155, BoardLocationX = 4, BoardLocationY = 10, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 161, BoardLocationX = 10, BoardLocationY = 10, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 166, BoardLocationX = 0, BoardLocationY = 11, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 169, BoardLocationX = 3, BoardLocationY = 11, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 173, BoardLocationX = 7, BoardLocationY = 11, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 177, BoardLocationX = 11, BoardLocationY = 11, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 180, BoardLocationX = 14, BoardLocationY = 11, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 183, BoardLocationX = 2, BoardLocationY = 12, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 187, BoardLocationX = 6, BoardLocationY = 12, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 189, BoardLocationX = 8, BoardLocationY = 12, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 193, BoardLocationX = 12, BoardLocationY = 12, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 197, BoardLocationX = 1, BoardLocationY = 13, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 201, BoardLocationX = 5, BoardLocationY = 13, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 205, BoardLocationX = 9, BoardLocationY = 13, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 209, BoardLocationX = 13, BoardLocationY = 13, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 211, BoardLocationX = 0, BoardLocationY = 14, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 214, BoardLocationX = 3, BoardLocationY = 14, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 218, BoardLocationX = 7, BoardLocationY = 14, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 222, BoardLocationX = 11, BoardLocationY = 14, BoardID = 1, BoardTileTypeID = 1 });
            ...
            modelBuilder.Entity<BoardTile>().HasData(new BoardTile { ID = 225, BoardLocationX = 14, BoardLocationY = 14, BoardID = 1, BoardTileTypeID = 1 });


            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 1, Letter = '*', Score = 0, GameLanguageID = 1 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 2, Letter = 'A', Score = 1, GameLanguageID = 1 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 3, Letter = 'B', Score = 3, GameLanguageID = 1 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 4, Letter = 'C', Score = 3, GameLanguageID = 1 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 5, Letter = 'D', Score = 2, GameLanguageID = 1 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 6, Letter = 'E', Score = 1, GameLanguageID = 1 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 7, Letter = 'F', Score = 4, GameLanguageID = 1 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 8, Letter = 'G', Score = 2, GameLanguageID = 1 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 9, Letter = 'H', Score = 4, GameLanguageID = 1 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 10, Letter = 'I', Score = 1, GameLanguageID = 1 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 11, Letter = 'J', Score = 8, GameLanguageID = 1 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 12, Letter = 'K', Score = 5, GameLanguageID = 1 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 13, Letter = 'L', Score = 1, GameLanguageID = 1 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 14, Letter = 'M', Score = 3, GameLanguageID = 1 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 15, Letter = 'N', Score = 1, GameLanguageID = 1 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 16, Letter = 'O', Score = 1, GameLanguageID = 1 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 17, Letter = 'P', Score = 3, GameLanguageID = 1 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 18, Letter = 'Q', Score = 10, GameLanguageID = 1 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 19, Letter = 'R', Score = 1, GameLanguageID = 1 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 20, Letter = 'S', Score = 1, GameLanguageID = 1 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 21, Letter = 'T', Score = 1, GameLanguageID = 1 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 22, Letter = 'U', Score = 1, GameLanguageID = 1 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 23, Letter = 'V', Score = 4, GameLanguageID = 1 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 24, Letter = 'W', Score = 4, GameLanguageID = 1 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 25, Letter = 'X', Score = 8, GameLanguageID = 1 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 26, Letter = 'Y', Score = 4, GameLanguageID = 1 });
            modelBuilder.Entity<CharTile>().HasData(new CharTile { ID = 27, Letter = 'Z', Score = 10, GameLanguageID = 1 });
            ...
            modelBuilder.Entity<Pouch_CharTile>().HasData(new Pouch_CharTile { ID = 1, PouchID = 1, CharTileID = 1, Count = 5 });
            modelBuilder.Entity<Pouch_CharTile>().HasData(new Pouch_CharTile { ID = 2, PouchID = 1, CharTileID = 2, Count = 3 });
            modelBuilder.Entity<Rack_CharTile>().HasData(new Rack_CharTile { ID = 1, RackID = 1, CharTileID = 3, Count = 5 });
            modelBuilder.Entity<Rack_CharTile>().HasData(new Rack_CharTile { ID = 2, RackID = 2, CharTileID = 4, Count = 4 });                               
        }
    }
